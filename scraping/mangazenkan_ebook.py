...
import pandas as pd
import time
from browser import init_browser  # Usamos el navegador centralizado

def web():
    url = "https://www.mangazenkan.com/r/yearly/ebook/2024/"
    ...
    df.to_csv("../Data/raw/mangazenkan_ebook.csv", index=False)
    print(df.head())
